...
game.prototype= {
    ...
    getLetter: function (num) {
        ...
        for (var i = 0; i < arr.length; i++) {
            ...
            span.style.cssText = "width:" + width + "px;position:absolute;left:" + x + "px;top:" + y + "px;background:url(images/zm.png);display:block;height:130px;color:#000;background-size:cover;font-size:30px;text-align:center";
